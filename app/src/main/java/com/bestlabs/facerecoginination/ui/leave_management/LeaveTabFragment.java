...
public class LeaveTabFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.leave_tab_fragment, container, false);
    ...
    private void switchFragment(int position) {
        ...
        switch (position) {
            case 0:
                selectedFragment = new LeaveSupervisorManagementFragment(); // Replace with your fragment class
                break;
            case 1:
                selectedFragment = new LeaveSupervisorApproveFragment(); // Replace with your fragment class
                break;
        }
